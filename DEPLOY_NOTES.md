...
### Nuevo: CSV ? MySQL y uso de BBDD en producci�n
...
- Nuevos endpoints API:
  - `/api/componentes`
  - `/api/repertory`
  Con `USE_DB=1` responden desde MySQL; sin esa variable leen los CSV. El front ya consume estas APIs, as� que en local sigue con CSV y en Plesk ir� contra la BBDD.
